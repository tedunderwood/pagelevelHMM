...
public class Model {
	...
	public static void main(String[] args) {
		...
		else if (command.equals("crossvalidate")) {
			int folds = Integer.parseInt(args[1]);
			crossValidate(folds, ridge);
		}
	}
		
	private static void selfTest(String ridge){	
		ArrayList<double[]> classProbs = new ArrayList<double[]>(numInstances);
		...
		selfsmooth(classProbs, corpus, markov);
